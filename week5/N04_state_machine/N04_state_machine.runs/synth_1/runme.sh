...
HD_PWD='C:/Users/user/git/ECE_exp2/week5/N04_state_machine/N04_state_machine.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log updown_counter_3bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source updown_counter_3bit.tcl
