...
HD_PWD='C:/Users/user/git/ECE_exp2/week5/N04_state_machine/N04_state_machine.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log updown_counter_3bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source updown_counter_3bit.tcl -notrace
